  ...
  render() {
    ...
    return (
      <>
        ...
        <div className="w-11/12 md:w-5/6 mx-auto text-squid-200 flex flex-col">
          <div className="mt-3">
              ...
              <div>
                <label htmlFor="search">
                  ...
                  <input
                    ...
                    className="w-full outline-none border-b md:border-0 mb-2 mt-2"
                  />
                </label>
              </div>
          ...
          <div className="mt-8">
            ...
            <p className="mt-2">
              ...
              you turn heads, but the adrenaline that results from the power of
              this car will excite even the most seasoned drivers. Want to drive
              along the coast and feel the refreshing breeze? No problem, you
              can remove the top to turn the car into a convertible!
            </p>
          </div>
          <div className="mt-6">
          ...
          <div className="mt-6">
            ...
            <div className="mt-3">
              ...
              <p>
                ...
                after your trip. Purchasing this ensures you get the car washed
                inside and out.
              </p>
            ...
            <div className="mt-3">
              ...
              <p>
                I will give you a magnetic piece that you attach to your phone.
              </p>
